...
// album
var WECHAT_ALBUM_FETCH_MOMENTS = exports.WECHAT_ALBUM_FETCH_MOMENTS = 'WECHAT_ALBUM_FETCH_MOMENTS';
var WECHAT_ALBUM_GET_FRIEND = exports.WECHAT_ALBUM_GET_FRIEND = 'WECHAT_ALBUM_GET_FRIEND';
...
exports.default = (0, _redux.combineReducers)({
  ...
  momentsMain: _moments2.default,
  albumMain: _album2.default
});
...
exports.default = function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _extends4.default)({}, defaultState);
  var action = arguments[1];

  switch (action.type) {
    case _ActionTypes.WECHAT_ALBUM_FETCH_MOMENTS:
      return (0, _extends4.default)({}, state, (0, _defineProperty3.default)({}, action.payload.wxid, action.payload.moments));
    default:
      return state;
  }
};
